  ...
  return (
    <div className='flex sm:flex-col md:flex-col pt-[6rem] pb-[6rem] pl-[4.8rem] xxl:pl-[5rem] xxl:pr-[5rem] sm:pl-[1.5rem] pr-[4.2rem] sm:pr-[1.5rem] gap-[4rem] xxl:gap-[3rem] lg:gap-[4rem]'>
        <div className='flex w-[60%] sm:w-[100%] md:w-[100%] items-center'>
            <img src={zoboOne} className="w-[18rem] h-[20rem] nxxx:h-[14rem] sm:h-[18rem] spxx:h-[16rem] z-5" loading='eager' />
            <img src={zoboTwo} className="w-[25rem] lg:w-[30rem] nxxx:w-[15rem] nxxx:h-[18rem] h-[25rem] sm:h-[22rem] spxx:h-[20rem] spxx:w-[22rem] ml-[-5rem] sm:ml-[-11rem] spxx:ml-[-14rem] lg:ml-[-13rem] nxx:ml-[-13rem]" loading='eager' />
        </div>
