...
const SectionFour = () => {
  return (
    <div className='flex flex-wrap flex-col justify-center items-center pt-[6rem]'>
        ...
        <div className="bg-[url('../../../../chilli-transformed.webp')] relative bg-cover w-[14rem] h-[14rem] nxxx:w-[9rem] nxxx:h-[9rem] sm:w-[11rem] sm:h-[11rem] lg:w-[12rem] lg:h-[12rem] md:w-[18rem] md:h-[18rem] flex justify-center items-center">
        ...
        <div className="bg-[url('../../../../chilli-transformed.webp')] relative bg-cover w-[14rem] h-[14rem] lg:w-[12rem] lg:h-[12rem] flex justify-center items-center sm:hidden md:hidden">
            <div className="absolute inset-0 bg-black opacity-70" ></div>
        ...
        <div className="bg-[url('../../../../chilli-transformed.webp')] relative bg-cover w-[14rem] h-[14rem] nxxx:w-[9rem] nxxx:h-[9rem] lg:w-[12rem] lg:h-[12rem] sm:w-[11rem] md:w-[18rem] md:h-[18rem] sm:h-[11rem] flex justify-center items-center">
            <div className="absolute inset-0 bg-black opacity-70" ></div>
            <div className="text-white z-10 offerText text-3xl md:text-[2.2rem] nxxx:text-[1.6rem]">$25</div>
        </div>
        <div className='bg-stone-600 w-[14rem] h-[14rem] lg:w-[12rem] lg:h-[12rem] flex flex-col justify-center pl-5 gap-2 text-white sm:hidden md:hidden'>
