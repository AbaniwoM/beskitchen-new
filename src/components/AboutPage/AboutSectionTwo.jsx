  ...
  return (
    <div className='flex flex-col gap-8 items-center p-[5rem] sm:p-[2rem] md:p-[4rem] lg:p-[2rem] sm:mt-[5rem] lg:mt-[6rem]'>
        ...
        <div className='flex sm:flex-col md:flex-col gap-6'>
            ...
            <img src={TeamOne} className="w-[80rem] md:w-[26rem] h-[30rem] nxxx:h-[22rem] nxx:h-[23rem] nxx:w-[17rem] nx:h-[25rem] nx:w-[19rem] sm:h-[32rem] sp:h-[28rem] md:h-[34rem] lg:h-[24rem]" loading='eager' alt='bobby-img'/>
            ...
            <img src={TeamTwo} className="w-[80rem] h-[30rem] nxxx:h-[22rem] sm:h-[32rem] nxx:h-[23rem] nxx:w-[17rem] nx:h-[25rem] nx:w-[19rem] sp:h-[28rem] md:w-[26rem] md:h-[34rem] lg:h-[24rem]" loading='eager' alt='bianca-img'/>
            <div className='flex flex-col items-center gap-2 nxxx:gap-[0.1rem] nxx:gap-[0.1rem] nx:gap-[0.1rem]'>
            ...
            <div className='flex flex-col items-center gap-5 sm:mt-4 md:mt-8'>
            <img src={TeamThree} className="w-[80rem] h-[30rem] nxxx:h-[22rem] nxx:h-[23rem] nxx:w-[17rem] nx:h-[25rem] nx:w-[19rem] sm:h-[32rem] sp:h-[28rem] md:w-[26rem] md:h-[34rem] lg:h-[24rem]" loading='eager' alt='jeremy-img'/>
            <div className='flex flex-col items-center gap-2 nxxx:gap-[0.1rem] nxx:gap-[0.1rem] nx:gap-[0.1rem]'>
