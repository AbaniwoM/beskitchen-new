    ...
    <>
      <header className="">
        ...
        {nav ? (
          // close button
          <i
            className="fixed left-[19.5rem] md:left-[40rem] top-[1rem] md:top-[1.2rem] md:text-4xl text-3xl text-black z-50 sm:block md:block cursor-pointer"
            aria-hidden="true"
            onClick={showNav}
          ><LiaTimesSolid /></i>
        ) : (
        ...
        >
        <div className='sm:text-black sm:flex sm:flex-col sm:gap-[2rem] sm:text-[1.3rem] md:flex md:flex-col md:gap-[3rem] md:text-[2rem]'>
        ...
        <div className='bg-stone-600 w-[13rem] md:w-[21rem] h-[3rem] md:h-[5rem] flex items-center justify-center text-white ml-5 cursor-pointer hover:bg-stone-500'>+234-111-1111-111</div>
        </div>
        </nav>
      </header>
    </>
