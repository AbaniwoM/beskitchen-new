    ...
    <>
      <header className="">
        ...
        {nav ? (
          // close button
          <i
            className="fixed left-[19.5rem] sm:text-[1.5rem] sp:left-[18.3rem] spx:left-[21.6rem] sm:left-[19.8rem] md:left-[40rem] top-[1rem] sm:top-[0.9rem] md:top-[1.2rem] md:text-4xl text-3xl text-black z-50 sm:block md:block cursor-pointer"
            aria-hidden="true"
            onClick={showNav}
          ><LiaTimesSolid /></i>
        ) : (
