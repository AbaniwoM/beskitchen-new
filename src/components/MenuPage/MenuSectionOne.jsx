...
const MenuSectionOne = () => {
  return (
    <div>
        <div className="bg-[url('../../../menu.png')] relative bg-cover h-[80vh] md:h-[75vh] spxx:h-[105vh] flex flex-col flex-wrap justify-end gap-[1rem] m-[4rem] sm:m-[2rem]">
        ...
        <h3 className="spice-text text-white relative z-10 text-4xl md:text-5xl sm:text-[2.5rem]">Starters</h3>
