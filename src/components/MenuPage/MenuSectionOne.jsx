...
const MenuSectionOne = () => {
  return (
    <div>
        <div className="bg-[url('../../../menu.png')] relative bg-cover h-[80vh] nxxx:h-[70vh] md:h-[75vh] spxx:h-[105vh] flex flex-col flex-wrap justify-end gap-[1rem] m-[4rem] sm:m-[2rem]">
