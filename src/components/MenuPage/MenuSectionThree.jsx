...
const MenuSectionThree = () => {
  return (
    <div>
        <div className="bg-[url('../../../spice.jpg')] relative bg-cover sm:bg-center md:bg-center lg:bg-center h-[80vh] nxxx:h-[70vh] spxx:h-[105vh] md:h-[75vh] flex flex-col flex-wrap justify-end gap-[1rem] m-[4rem] sm:m-[2rem]">
        ...
        <p className='md:text-[1.3rem] lg:text-[1.3rem] lg:w-[80%] sm:text-[1.1rem] nx:text-[0.9rem] nxx:text-[0.9rem] nxxx:text-[0.9rem]'>Choose your favorite category mauris orci dignissim nisl, id gravida nunc enim quis nibh.</p>
