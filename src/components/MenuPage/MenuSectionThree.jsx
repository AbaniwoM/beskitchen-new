...
const MenuSectionThree = () => {
  return (
    <div>
        <div className="bg-[url('../../../spice.jpg')] relative bg-cover sm:bg-center md:bg-center lg:bg-center h-[80vh] md:h-[75vh] flex flex-col flex-wrap justify-end gap-[1rem] m-[4rem] sm:m-[2rem]">
        ...
        <h3 className="spice-text text-white relative z-10 text-4xl md:text-5xl">Spicies</h3>
