...
const Footer = () => {
  return (
    <div className='bg-stone-600 h-[80vh] md:h-[122vh] sm:h-[180vh] nx:h-[145vh] yx:h-[152vh] nxx:h-[147vh] nxxx:h-[150vh] spxxx:h-[150vh] lg:h-[110vh] spx:h-[142vh] spxx:h-[230vh]  md:text-center lg:text-center md:justify-center sm:text-center sm:justify-center flex flex-col sm:flex-col flex-wrap justify-center gap-[5rem] items-center text-white sm:text-[1.2rem] yx:text-[1rem] nx:text-[0.9rem] nxx:text-[0.9rem] nxxx:text-[0.9rem] md:text-[1.4rem] lg:text-[1.4rem]'>
