...
const Footer = () => {
  return (
    <div className='bg-stone-600 h-[80vh] md:h-[122vh] sm:h-[180vh] spxxx:h-[150vh] lg:h-[110vh] spx:h-[142vh] spxx:h-[230vh]  md:text-center lg:text-center md:justify-center sm:text-center sm:justify-center flex flex-col sm:flex-col flex-wrap justify-center gap-[5rem] items-center text-white sm:text-[1.2rem] md:text-[1.4rem] lg:text-[1.4rem]'>
