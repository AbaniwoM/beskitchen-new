...
const Hero = () => {
  return (
    <div className="bg-[url('../../../bg-transformed.jpeg')] bg-cover h-[85vh] nxxx:h-[97vh] nxx:h-[107vh] nx:h-[108vh] spxx:h-[120vh] spy:h-[90vh] spxxx:h-[100vh] flex flex-wrap justify-start gap-[1rem] sm:gap-[0rem] pt-[9rem] xxl:pt-[11rem] md:pt-[12rem] spxx:pt-[7.5rem] sm:pt-[10rem] lg:pt-[14rem]">
